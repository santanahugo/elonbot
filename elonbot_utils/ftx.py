...
class FtxClient:
    ...
    def get_index(self, market_name: str, resolution: int, limit: int, start_time: int, end_time: int) -> dict:
    ...
    def get_funding_rates(self, future: str, start_time: int, end_time: int) -> dict:
        return self._get(f'funding_rates', {'future': future,
                                            'start_time': start_time,
                                            'end_time': end_time})
